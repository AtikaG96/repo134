...
const WorkExperience = () => {
  const experiences = [
    { title: "IT Brukerstøtte, Universitet i Oslo", date: "01.26 - 07.26", 
      description: "Arbeid med drift og vedlikehold av IT-tjenester og brukersystemer, Saksbehandling og håndtering av tekniske henvendelser i RT-system, Identitets- og tilgangsadministrasjon (Active Directory og BOFH), Arbeid med autentiseringsløsninger (Microsoft Authenticator / MFA), Feilsøking av klienter og systemer (Workspace One)," ,responsibilities: ["Bidro til stabilitet, sikkerhet og effektiv drift av IT-tjenester"] },
    { title: "Teknisk vakt, BI Handelshøyskolen", date: "06.2023 - Nå", description: "Jeg jobber som teknisk vakt ved BI Handelshøyskolen, hvor jeg støtter studenter under eksamensperioder med å løse nettverksproblemer, innloggingsutfordringer og sikre at besvarelser blir riktig lagret.", responsibilities: ["Testing av systemet Device Monitor, som tar skjermbilder av studentenes skjermer under eksamener.", "Overvåking av hvilke nettsider studentene besøker under eksamen, ettersom systemet fungerer som en åpen plattform."] },
